...
import questions from "~/data/semester-satu-bahasa-inggris-2";
...
useHead({
  title: "Soal Bahasa Inggris - Body Parts & Activity",
  meta: [
    {
      name: "Kumpulan soal Bahasa Inggris 2",
      content: "Kumpulan soal Bahasa Inggris 2",
    },
  ],
});
</script>
