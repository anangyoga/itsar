...
import questions from "~/data/semester-satu-bahasa-inggris";
...
useHead({
  ...
  meta: [
    {
      name: "Kumpulan soal Bahasa Inggris 1",
      content: "Kumpulan soal Bahasa Inggris 1",
    },
  ],
});
</script>
